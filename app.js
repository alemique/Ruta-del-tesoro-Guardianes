...
    // NUEVA ADICIÓN: useEffect para hacer scroll al principio de la página
    React.useEffect(() => {
        window.scrollTo(0, 0);
    }, [appState.status, appState.currentMissionId, appState.subStage, appState.activeDistortionEventId, appState.activeBonusMissionId]);
    // Las dependencias aseguran que el scroll se active en cada cambio relevante de vista.
    
    React.useEffect(() => {
